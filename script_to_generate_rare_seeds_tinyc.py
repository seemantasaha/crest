...
def main(pathDir, projectDir, binaryWithArg):
    ...
    for k,v in sp.items():
        ...
        command = "cd " + projectDir + " && time ../crest/bin/run_crest 'echo \"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\" | /home/seem/Research/tinyC/tiny' 10 -pge \"" + path_node[:-1] + "\" > " + logDir + "/log_" + str(num) + ".txt"
        print(command)
